/**
 * Transactional email via Nodemailer (SMTP) — OTP for Admins.
 */
...
export async function sendOtpEmail(params: {
  ...
  const subject = "Your VegFru Admin verification code";
  ...
  <div style="max-width:480px;margin:0 auto;background:#fff;border-radius:16px;padding:28px;border:1px solid #e2e8f0;">
    <div style="font-size:22px;font-weight:700;color:#14532d;margin-bottom:8px;">🌿 VegFru Admin</div>
    <p style="color:#334155;font-size:15px;line-height:1.5;">Hi,</p>
    <p style="color:#334155;font-size:15px;">Use this code to verify your login to the admin dashboard:</p>
