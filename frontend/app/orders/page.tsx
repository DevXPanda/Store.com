...
import { ArrowLeft, Package, Clock, CheckCircle, XCircle, Truck, ChevronDown, ChevronUp, ShoppingBag, RefreshCw, X, Loader2 } from 'lucide-react'
      ...
      <div style={{ maxWidth:800, margin:'0 auto', padding:'32px 20px' }}>
        ...
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:24 }}>
          <div style={{ display:'flex', alignItems:'center', gap:12 }}>
            ...
            <div>
              <h1 style={{ fontSize:22, fontWeight:700, color:'#14532d', margin:0 }}>My Orders</h1>
              <p style={{ fontSize:13, color:'#6b7280', margin:0 }}>{orders.length} order{orders.length !== 1 ? 's' : ''} found</p>
            </div>
          </div>
          <button onClick={() => fetchOrders(true)} disabled={refreshing}
            style={{ display:'flex', alignItems:'center', gap:6, background:'white', border:'1px solid #e5e7eb', borderRadius:10, padding:'8px 14px', fontSize:13, cursor:'pointer', color:'#374151' }}>
        ...
        {loading ? (
          ...
          <div style={{ background:'white', borderRadius:20, padding:56, textAlign:'center', border:'1px solid #e5e7eb' }}>
          ...
          <div style={{ display:'flex', flexDirection:'column', gap:12 }}>
            {orders.map((order: any) => {
              ...
              return (
                <div key={order._id} style={{ background:'white', borderRadius:20, border:'1px solid #e5e7eb', overflow:'hidden', transition:'box-shadow 0.2s' }}>
